...
draft: false
summary: 'Deploy Next.js application to Vercel using GitHub Actions'
layout: PostSimple
---
...
<Image alt="GitHub Secrets" src="/static/images/blog/vercel-deploy/githubSecrets.png" width={2214} height={1596}/>
...
<Image alt="Vercel Build & Development Settings" src="/static/images/blog/vercel-deploy/vercelBuildSettings.png" width={1846} height={1090}/>
